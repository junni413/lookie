...
public class WorkLogResponseDto {
    ...
    @JsonIgnore
    private String name; // 포맷팅 전 원본 이름
    @JsonIgnore
    private String phoneNumber; // 포맷팅 전 원본 전화번호
    ...
    public static WorkLogResponseDto from(WorkLog workLog, WorkLogEvent lastEvent) {
        return WorkLogResponseDto.builder()
                ...
                .plannedEndAt(workLog.getPlannedEndAt() != null ? workLog.getPlannedEndAt().toString() : null)
                .build();
    }
}