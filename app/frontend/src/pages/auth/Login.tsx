...
export default function Login() {
  ...
  return (
    <div className="min-h-[100dvh] bg-white px-4">
      {/* ✅ 모바일: 430 규격 / 데스크탑(md~): 560 확장 */}
      <div className="mx-auto w-full max-w-[430px] md:max-w-[560px] text-center pt-14 md:pt-24 pb-10">
        {/* ✅ 모바일에서는 작게, 데스크탑에서 크게 */}
        <h1 className="mb-8 md:mb-12 text-4xl md:text-6xl font-extrabold text-blue-600">
          Lookie
        </h1>

        {/* ✅ 내부도 모바일=430, 데스크탑에서만 살짝 확장 */}
        <div className="mx-auto w-full max-w-[430px] md:max-w-[520px] space-y-4 md:space-y-6">
          ...
          {import.meta.env.DEV && (
            <div className="mt-10 md:mt-14 flex flex-col items-center gap-4">
              <div className="text-xs tracking-widest text-gray-300">DEV ONLY</div>
